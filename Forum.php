		...
		<form action=" " method="post" enctype="multipart/form-data">
				...
				<br/> <br/><br/>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" name="Poids" id="Poids" placeholder="Entrer votre Poids" required>
						</div>
				    </div>
					...
					<div class="form-group">    
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
						<select class="form-control" id='sexe' name="sexe"  class="common_selector sexe"  required>
						<option>Homme</option>
