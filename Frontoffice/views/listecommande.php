...
<head>
	<title>Restaurant dinner | Panier</title>
...
<div class="checkout">
	<div class="container">
		<div>
                                ...
                                $commandes=$commandeC->recuperercommande($_SESSION['id']);
                                $commandes1=$commandeC->recuperercommande1($_SESSION['id']);
                                    ...
                                    <tr>
                                        ...
                                        <td>
											  ...
											  <form method="POST" action="affichercontenucommande.php">
											        <button name="contenu" ><img src="images/eye.png"></button>
