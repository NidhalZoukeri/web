...
class SMTP
{
    ...
    /**
     * Get metadata produit the SMTP server from its HELO/EHLO response.
    ...
    public function getServerExt($name)
    {
        ...
        if (!array_key_exists($name, $this->server_caps)) {
            ...
            $this->setError('HELO handshake was used; No information produit server extensions available');
