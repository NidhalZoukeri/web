...
<body>
    ...
    // Check if file was uploaded without errors
        if (isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
            ...
            $extensions_arr = array("jpg","pdf","txt","jpeg","png","csv","xls","xlsx","xlsm","doc");
            ...
            if (in_array($videoFileType, $extensions_arr)) {
                ...
                if (file_exists("upload/" . $filename)) {
                    ...
                    move_uploaded_file($_FILES["file"]["tmp_name"], "upload/" .'file'.'-'.$filename);
                    $repertoir="upload/".'file'.'-'.$filename;
                }
            } else {
    ...
    $query = mysqli_query($conn, "insert into conseil( Nom , Description , image ) value ( '$Nom' , '$Description' , '$repertoir') ");
    if ($query) {
        echo "<script>alert('conseil ajouté avec succès!');</script>";
    } else {
...
?>
		...
		<form action=" " method="post" enctype="multipart/form-data">
				...
				<br/> <br/><br/>
					  <div class="form-group">
                         <label class="control-label col-md-2 col-sm-1 col-xs-4">Description<span class="required"><font color="red">&nbsp;*</font></span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
