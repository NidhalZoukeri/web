...
$conn  = mysqli_connect($sname, $uname, $password, $db_name);
    ...
    if(!$conn){
        echo "<h3 class='container bg-dark p-3 text-center text-dark rounded-lg mt-5'>Not able to establish Database Connection<h3>";
    }

    // Get data to display on conseil page
    ...
    if(isset($_REQUEST['new_post'])){
        ...
        header("Location: conseil.php?info=added");
        exit();
    }
